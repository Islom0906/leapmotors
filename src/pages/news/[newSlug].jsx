...
const NewsInner = () => {
  return (
    <>
        ...
        <section>
        <div class="container ">
          <div class="mt-[95px] mb-[35px] md:mb-[40px]">
            <Link
              href="/news"
              class="text-[#4d5d81] text-[20px] font-semibold"
              >News Room
              </Link>
          </div>
          <h1
            class="font-bold text-justify text-[18px] leading-[35px] md:leading-[60px] md:text-[30px]"
          >
            Leapmotor’s First Mass Production Model with CTC Technology
          </h1>
          <p class="tracking-[.12rem] text-justify text-[18px] leading-[35px] mt-3">
            February 25, 2022
          ...
          <div className='mb-10'>
            <p class="text-[20px] mt-7 font-bold">
              Technological and Natural Aesthetics to Create an Inner "Style"
            </p>
            <p
              class="tracking-[.12rem] text-justify text-[18px] leading-[35px] mt-3"
            >
            ...
            <Image
              class="mt-[35px] aspect-video w-full object-cover"
              src={news1}
              alt="news name"
            />
          </div>
