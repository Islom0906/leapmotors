          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 ">
            ...
            <div className="col-span-1 space-y-3 md:col-span-2">
              ...
              <div>
                ...
                />
                {errors.carExperience && <span className={'text-red-600 text-xs'}>Требуется опыт</span>}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="шт"
                />
                {errors.infoAboutSoldCard && <span className={'text-red-600 text-xs'}>Требуется реальные автомобили проданы</span>}
