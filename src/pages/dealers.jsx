...
const dealers = () => {
    ...
    return (
        <>
          <Head>
            <title>Leapmotorca Dealers</title>
            <meta property='og:title' content="Leapmotorca uz Dealers, Leapmotor uzbekistan Dealers,Leapmotorca Dealers"/>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="grid grid-cols-1 gap-5 mb-5">
                            <div>
                                ...
                                {errors.nameEnterprises &&
                                    <span className={'text-red-600 text-xs'}>Требуется название</span>}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-5 mb-5">
                            ...
                            <div>
                                ...
                                />
                                {errors.countUser &&
                                    <span className={'text-red-600 text-xs'}>Требуется численность населения</span>}
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mb-5">
                            <div>
                                ...
                                {errors.otherInformation &&
                                    <span className={'text-red-600 text-xs'}>Требуется банковские реквизиты</span>}
                                ...
                                <div className="flex justify-between space-x-5 ">
                                    <div className="w-full">
                                        ...
                                        {errors.showroomTotalArea &&
                                            <span className={'text-red-600 text-xs'}>Требуется общая площадь</span>}
                                    ...
                                    <div className={'w-full'}>
                                        ...
                                        {errors.showroomUsableArea &&
                                            <span className={'text-red-600 text-xs'}>Требуется полезная площадь</span>}
                            ...
                            <div className="col-span-1 space-y-5 md:col-span-2">
                                ...
                                <div>
                                    ...
                                    {errors.carExperience &&
                                        <span className={'text-red-600 text-xs'}>Требуется опыт периода</span>}
                                ...
                                <div>
                                    ...
                                    {errors.infoAboutSoldCard &&
                                        <span className={'text-red-600 text-xs'}>Информация о фактическом количестве проданных автомобилей</span>}
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.salesMonth &&
                                        <span className={'text-red-600 text-xs'}>Требуется продаж в месяц</span>}
                            ...
                            <div className="flex col-span-1 gap-2 md:col-span-3 ">
                                <div>
                                    ...
                                    {errors.contactPerson &&
                                        <span className={'text-red-600 text-xs'}>Требуется контактное лицо</span>}
                                ...
                                <div>
                                    ...
                                    {/*/>*/}
                                    {errors.contactPhone &&
                                        <span className={'text-red-600 text-xs'}>Требуется контактный номер</span>}
