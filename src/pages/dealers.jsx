        ...
        <div className="container space-y-3">
          ...
          <div className="grid grid-cols-1 gap-5">
            <div>
              ...
              />
              {errors.nameEnterprises && <span className={'text-red-600 text-xs'}>Требуется название</span>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 ">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Адрес"
              />
              {errors.address && <span className={'text-red-600 text-xs'}>Требуется адрес</span>}
            ...
            <div>
              ...
              />
              {errors.countUser && <span className={'text-red-600 text-xs'}>Требуется численность населения</span>}
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 ">
            <div>
              ...
              ></textarea>
              {errors.otherInformation && <span className={'text-red-600 text-xs'}>Требуется банковские реквизиты</span>}
              ...
              <div className="flex justify-between space-x-1 ">
                <div className="w-full">
                  ...
                  <input
                    ...
                    placeholder="кв м"
                  />
                  {errors.showroomTotalArea && <span className={'text-red-600 text-xs'}>Требуется общая площадь</span>}
                ...
                <div className={'w-full'}>
                  ...
                  <input
                    ...
                    placeholder="кв м"
                  />
                  {errors.showroomUsableArea && <span className={'text-red-600 text-xs'}>Требуется полезная площадь</span>}
              ...
              <div className="flex justify-between space-x-1">
                <div  className="w-full">
                  ...
                  <input
                    ...
                    placeholder="кв м”"
                  />
                  {errors.serviceTotalArea && <span className={'text-red-600 text-xs'}>Требуется общая площадь</span>}
                </div>
                <div  className="w-full">
                  <label
                  ...
                  <input
                    ...
                    placeholder="кв м”"
                  />
                  {errors.serviceUsableArea && <span className={'text-red-600 text-xs'}>Требуется полезная площадь</span>}
            ...
            <div className="col-span-1 space-y-3 md:col-span-2">
              ...
              <div>
                ...
                />
                {errors.carExperience && <span className={'text-red-600 text-xs'}>Требуется опыт периода</span>}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="шт"
                />
                {errors.infoAboutSoldCard && <span className={'text-red-600 text-xs'}>Информация о фактическом количестве проданных автомобилей</span>}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="шт"
                />
                {errors.salesMonth && <span className={'text-red-600 text-xs'}>Требуется продаж в месяц</span>}
            ...
            <div className="flex col-span-1 gap-2 md:col-span-3 ">
              <div>
                ...
                <input
                  ...
                  placeholder="Иван"
                />
                {errors.contactPerson && <span className={'text-red-600 text-xs'}>Требуется контактное лицо</span>}
