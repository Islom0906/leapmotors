        ...
        <section className="h-screen   mb-20 md:mb-0">
            <div className="h-full w-full relative">
                ...
                <div className="absolute top-[45px] md:top-20 w-full text-center z-20">
                    ...
                    <div>
                        <div
                            className="mx-auto text-left flex  md:flex-row flex-col justify-between md:justify-start items-center gap-y-[10px] gap-x-[30px] px-5 sm:px-20 md:px-0 w-full md:w-fit">
                            <div
                                className="flex flex-row md:flex-col justify-between md:justify-start items-center w-full">
                                <div className="mb-3">
                                    <p data-aos="fade-up"
                                       data-aos-anchor-placement="top-bottom"
                                       className="text-xs md:text-base text-white opacity-80 font-thin leadin-[16px]">
                                        C11 Extended Range
                                    </p>
                                    <p data-aos="fade-up"
                                       data-aos-anchor-placement="top-bottom"
                            ...
                            <div
                                className="md:border-x border-white box-border md:px-[30px] flex flex-row md:flex-col justify-between md:justify-start items-center w-full">
                                <div className="mb-3">
                                    <p data-aos="fade-up"
                                       data-aos-anchor-placement="top-bottom"
                                       className="text-xs md:text-base text-white opacity-80 font-thin leadin-[16px]">
                                ...
                                <p data-aos="fade-up"
                                   data-aos-anchor-placement="top-bottom"
                                   className="text-xl md:text-[28px] text-left md:w-[200px] text-white font-semibold md:font-medium leading-[24px]">
                                    RMB 165,800
                                </p>
                            </div>
                            <div
