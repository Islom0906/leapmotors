  ...
  return (
    <>
     ...
     
     {
        bgRes ?
          <>  
            <Image src={bgRes} alt="car" className="block object-cover w-full h-full md:hidden" fill priority={true}/>
        ...
        <div  className={`absolute top-0 left-0 py-[60px] z-[100] w-full h-full text-center ${center ? 'flex justify-center items-center' : ''} `}>
          <div className={` mt-10 mb-5 text-center ${textColor ? `text-${textColor}` : 'text-white'} `}>
            ...
            <p data-aos='fade-up' data-aos-anchor-placement="top-bottom" className="text-sm font-normal md:leading-5 w-[90%] sm:w-[30%] mx-auto">{subTitle}</p>
          </div>
        </div>
